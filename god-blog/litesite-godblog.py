...
PATH_FROM_DOMAIN_TO_HERE = 'god-blog/'  # end in / if not ''
...
INFILE_EXT = 'godblog'  # can be anything; no leading dot
...
if __name__ == '__main__' and not _testing:
    ...
    if infile.exists():
        ...
        # --- CUSTOM ---
        # set custom placeholders appropriately for this page
        # --- END CUSTOM ---
